const projects = [
  {
    ...
    descriptionBody: `Solo project created with Three.js, Css animations and Express server.
  ...
  {
    id: 2,
    title: 'Colorado street art',
    description: 'Website for businesses to connect with street artists',
    descriptionBody: `Solo freelance project for a non-profit Colorado street art company. Custom website design, content and build services. 
  ...
  },
  {
    ...
    description: 'Design of a sample login form',
    descriptionBody:
  ...
  },
  {
    ...
    title: 'Form wizard',
    description:
      'Step by step decision making software guiding users to complete complex forms',
